...
- **Release actual publicada**: `2.5.0` con tag `v2.5.0`.
- **Release anterior publicada**: `2.4.0` con tag `v2.4.0`.
...
- **Versión estable consolidada**: `2.5.0`, por cambios funcionales en audiencia programada y logs tras `2.4.0`.
